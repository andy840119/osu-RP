...
using osu.Game.Rulesets.Karaoke.OsuDifficulty.Preprocessing;
using osu.Game.Rulesets.Karaoke.OsuDifficulty.Utils;

namespace osu.Game.Rulesets.Karaoke.OsuDifficulty.Skills
{
    /// <summary>
