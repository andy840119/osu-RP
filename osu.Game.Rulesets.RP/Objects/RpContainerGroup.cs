...
namespace osu.Game.Rulesets.RP.Objects
{
    ...
    ///     包住RP物件的容器
    /// </summary>
    public class RpContainerGroup : BaseRpObject, IHasID, IHasEndTime, IHasPosition, IHasRotation, IHasColor, IHasLength, IHasContainList<RpContainerLine>, IHasScale
    {
        //ID
        ...
        public RpContainerGroup(double startTime)
            : base(startTime)
        {
        }
