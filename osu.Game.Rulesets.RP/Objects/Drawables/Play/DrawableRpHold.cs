...
namespace osu.Game.Rulesets.RP.Objects.Drawables.Play
{
    ...
    ///     Slider
    /// </summary>
    public class DrawableRpHold : DrawableBaseRpHitableObject //, IHasTemplate<RpHoldObjectTemplate>
    {
        // HitObject
        public new RpHold HitObject
        {
            get { return (RpHold)base.HitObject; }
        }

        public DrawableRpHold(RpHold h)
            : base(h)
        {
        }
